...
'
  desc 'check', 'If the database is set up to write audit logs using APPLICATION or SECURITY event logs rather than writing to a file, this is Not Applicable.
...
9. Permission like a normal user from here.)
  impact 0.5
  tag check_id: 'C-75325r1108460_chk'
  tag severity: 'medium'
  tag gid: 'V-271282'
  tag rid: 'SV-271282r1109273_rule'
  tag stig_id: 'SQLI-22-005900'
  tag gtitle: 'SRG-APP-000118-DB-000059'
  tag fix_id: 'F-75232r1109273_fix'
