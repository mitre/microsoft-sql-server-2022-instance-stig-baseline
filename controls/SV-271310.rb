control 'SV-271310' do
  title 'Confidentiality of information during transmission must be controlled through the use of an approved TLS version.'
...
If any of the respective registry paths are non-existent or contain values other than specified above, this is a finding. If Vendor documentation supporting the configuration is provided, reduce this finding to a CAT III.'
  desc 'fix', 'Important Note: Incorrectly modifying the Windows Registry can result in serious system errors. Before making any modifications, ensure there is a recent backup of the system and registry settings.
...
11. Repeat steps 1-10 for "TLS 1.1", "SSL 2.0", and "SSL 3.0".'
  impact 0.7
  tag check_id: 'C-75353r1109244_chk'
  tag severity: 'high'
  tag gid: 'V-271310'
  tag rid: 'SV-271310r1111062_rule'
  tag stig_id: 'SQLI-22-008300'
  tag gtitle: 'SRG-APP-000175-DB-000067'
  tag fix_id: 'F-75260r1109245_fix'
  tag 'documentable'
