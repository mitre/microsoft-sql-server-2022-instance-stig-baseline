...
Request evidence that all users of the tool are trained on the importance of not using the plain-text password option, how to keep the password hidden, and that they adhere to this practice; if not, this is a finding.)
...
2. Train all users of the tool in the importance of not using the plain-text password option and in how to keep the password hidden."
  impact 0.7
  tag check_id: 'C-75356r1111144_chk'
  tag severity: 'high'
  tag gid: 'V-271313'
  tag rid: 'SV-271313r1111146_rule'
  tag stig_id: 'SQLI-22-018100'
  tag gtitle: 'SRG-APP-000178-DB-000083'
  tag fix_id: 'F-75263r1111145_fix'
  tag 'documentable'
