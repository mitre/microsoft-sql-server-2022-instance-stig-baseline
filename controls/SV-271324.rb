...
If the confidentiality and integrity of SQL Server data is not protected, the data will be open to compromise and unauthorized modification.'
  desc 'check', "Review system documentation to determine whether the system handles classified information. If the system does not handle classified information, the severity of this check is downgraded to CAT II. 
...
Implement physical security measures, operating system access control lists, and organizational controls appropriate to the sensitivity level of the data in the database(s).'
  impact 0.7
  tag check_id: 'C-75367r1109247_chk'
  tag severity: 'high'
  tag gid: 'V-271324'
  tag rid: 'SV-271324r1109248_rule'
  tag stig_id: 'SQLI-22-009500'
  tag gtitle: 'SRG-APP-000231-DB-000154'
  tag fix_id: 'F-75274r1109022_fix'
  tag 'documentable'
