control 'SV-271331' do
  title 'SQL Server and associated applications must reserve the use of dynamic code execution for situations that require it.'
...
If dynamic code execution is employed in circumstances where the objective could practically be satisfied by static execution with strongly typed parameters, this is a finding.'
  ...
  impact 0.5
  tag check_id: 'C-75374r1108607_chk'
  tag severity: 'medium'
  tag gid: 'V-271331'
  tag rid: 'SV-271331r1108609_rule'
  tag stig_id: 'SQLI-22-010010'
  tag gtitle: 'SRG-APP-000251-DB-000391'
  tag fix_id: 'F-75281r1108608_fix'
  tag 'documentable'
  tag cci: ['CCI-001310']
  tag nist: ['SI-10']
end
