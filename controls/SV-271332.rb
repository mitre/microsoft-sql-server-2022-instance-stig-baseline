control 'SV-271332' do
  title 'SQL Server and associated applications, when making use of dynamic code execution, must scan input data for invalid values that may indicate a code injection attack.'
...
If dynamic code execution is employed without protective measures against code injection, this is a finding.'
  ...
  impact 0.5
  tag check_id: 'C-75375r1108610_chk'
  tag severity: 'medium'
  tag gid: 'V-271332'
  tag rid: 'SV-271332r1108612_rule'
  tag stig_id: 'SQLI-22-010020'
  tag gtitle: 'SRG-APP-000251-DB-000392'
  tag fix_id: 'F-75282r1108611_fix'
  tag 'documentable'
  tag cci: ['CCI-001310']
  tag nist: ['SI-10']
end
