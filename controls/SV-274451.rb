control 'SV-274451' do
  title 'The Ole Automation Procedures feature must be disabled unless specifically required and approved.'
...
The "Ole Automation Procedures" extended stored procedure allows execution of host executables outside the controls of database access permissions. This access may be exploited by malicious users who have compromised the integrity of the SQL Server database process to control the host operating system to perpetrate additional malicious activity.'
  desc 'check', %q(To determine if the "Ole Automation Procedures" option is enabled, execute the following query: 
...
GO)
  impact 0.5
  tag check_id: 'C-78544r1111118_chk'
  tag severity: 'medium'
  tag gid: 'V-274451'
  tag rid: 'SV-274451r1111120_rule'
  tag stig_id: 'SQLI-22-017000'
  tag gtitle: 'SRG-APP-000141-DB-000093'
  tag fix_id: 'F-78449r1111119_fix'
  tag 'documentable'
